...
import { format, startOfMonth, endOfMonth, parseISO, addDays, subMonths, differenceInDays } from "date-fns";
...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Tab de Previsão de Vendas */}
      <TabsContent value="previsao" className="space-y-4">
        {/* Cards de Resumo de Previsão */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{avgPipelineVelocity} dias</div>
              <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card className="animate-fade-in" style={{ animationDelay: "0.4s" }}>
          ...
          <CardContent>
            <Tabs value={forecastTab.toString()} onValueChange={(v) => setForecastTab(Number(v) as 30 | 60 | 90)}>
              ...
              <TabsContent value="30" className="space-y-4 mt-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg border">
                    ...
                    <p className="text-2xl font-bold">
                      {allOpportunities.filter(o => o.status !== "won" && o.status !== "lost").length}
                    </p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="90" className="space-y-4 mt-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg border">
                    ...
                    <p className="text-2xl font-bold">
                      {formatCurrency(
                        projection90 / (allOpportunities.filter(o => o.status !== "won" && o.status !== "lost").length || 1)
                      )}
                    </p>
                  </div>
                </div>
